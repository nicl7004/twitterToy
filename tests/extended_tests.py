...
try:
    ...
    from modules import user, followingVsFollwers, followers_tweets_scatter, globalTrends, network
    from database import databaseHelper

except ImportError:                       #for python 3 and up
    sys.path.insert(0, os.path.abspath('..'))
    sys.path.append('../..')
    from twitterToy.modules import user, followingVsFollwers, followers_tweets_scatter, globalTrends, network
